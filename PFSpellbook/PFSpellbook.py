...
def parseArgs() -> argparse.Namespace:
    ...
    ap.add_argument("--custom-template", action="store", help="Add the path to another compatible html file for a template here")
...
def updateEnv():
    if os.environ.get("ISDOCKER", False):
        ...
        print("[?] Please ensure you have mounted folders to /in and /out")
    else:
